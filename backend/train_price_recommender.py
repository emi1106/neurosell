...
class PriceRecommendationSystem:
    ...
    def train(self, df: pd.DataFrame, test_size: float = 0.2, random_seed: int = 42) -> dict:
        ...
        # Encode categorical variables (fix: ensure all non-numeric columns are encoded)
        ...
        # Ensure all columns are numeric (convert any remaining non-numeric columns)
        for col in X_encoded.columns:
            if not np.issubdtype(X_encoded[col].dtype, np.number):
    ...
    def save_models(self, filepath_prefix: str = '/Users/fatemehpourkazemkhales/Desktop/neurosell/backend/models/mercari_price_suggestion_models'):
    ...
    def load_models(self, filepath_prefix: str = '/Users/fatemehpourkazemkhales/Desktop/neurosell/backend/datasets/mercari-price-suggestion-models'):
...
def main():
    ...
    df = system.load_and_preprocess_data(
        '/Users/fatemehpourkazemkhales/Desktop/neurosell/backend/datasets/neuro_dataset.csv',
    ...
    csv_filename = f'/Users/fatemehpourkazemkhales/Desktop/neurosell/backend/datasets/mercari_price_predictions_{best_model}.csv'
